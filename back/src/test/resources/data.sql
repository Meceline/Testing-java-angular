...
-- Insertion d'une SESSION avec Margot DELAHAYE
...
-- Insertion d'une  SESSION avec Hélène THIERCELIN
INSERT INTO SESSIONS (name, date, description, teacher_id, created_at, updated_at)
...
-- Ajout de l'utilisateur Jane DOE à la dernière SESSION
